...
repo's. It roams for the same reason the shell config does, and the symlink is what keeps it
...
- **The ssh config, `empower` and the tablet** have their own notes in
  [`dotfiles/ssh/README.md`](dotfiles/ssh/README.md), and **aichat's model choice** in
  [`dotfiles/aichat/README.md`](dotfiles/aichat/README.md).
